...
test('member dates use day and abbreviated month in the current local year', () => {
  ...
  assert.equal(parseTimeoffDate('10 September', '2026-01-01'), '2026-09-10');
  assert.equal(parseTimeoffDate('Sep 10', '2026-01-01'), '2026-09-10');
  assert.equal(parseTimeoffDate('September 10', '2026-01-01'), '2026-09-10');
  assert.equal(parseTimeoffDate('10 sepetember', '2026-01-01'), '2026-09-10');
  assert.equal(parseTimeoffDate('septemper 10', '2026-01-01'), '2026-09-10');
...
test('reject impossible dates, unknown months and non-leap-year February 29', () => {
  for (const value of ['31 Apr', '0 Sep', '12 Abc', '29 Feb']) {
